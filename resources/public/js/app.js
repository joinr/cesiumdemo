window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=f97f5b&fwbuild=dev"};
...
document.write('<script>goog.require("cesiumdemo.hello");</script>');
